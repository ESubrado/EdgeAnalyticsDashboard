          ...
          <div className="group relative overflow-hidden rounded-xl border border-slate-700 bg-slate-800 p-7 transition-all hover:border-violet-500/50 hover:shadow-xl hover:shadow-violet-500/10">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-violet-500/30 bg-violet-500/10 px-4 py-2 text-sm font-semibold text-violet-400 transition-colors hover:bg-violet-500/20"
              >
                View Demo <IoArrowForwardOutline className="h-4 w-4" />
              </a>
            </div>
          </div>
        </div>
